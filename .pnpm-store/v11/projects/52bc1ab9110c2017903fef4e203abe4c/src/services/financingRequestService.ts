...
export type ClientRegistrationVerificationResponse = { message: string; expiresInSeconds: number; resendAvailableInSeconds: number };

export const financingRequestService = {
  startRegistration: (data: unknown) => apiClient.post<ClientRegistrationVerificationResponse>('/api/client-registration', data),
  verifyRegistration: (email: string, code: string) => apiClient.post<ClientProfile>('/api/client-registration/verify', { email, code }),
  resendRegistrationCode: (email: string) => apiClient.post<ClientRegistrationVerificationResponse>('/api/client-registration/resend', { email }),
