                ...
                <CardContent className="join-step-spacing">
                  ...
                  <div>
                    ...
                    <label className="join-upload-area block" htmlFor="marketplace-banniere">
                      ...
                      {formData.banniere ? (
                        <div className="join-upload-content">
                          <div className="join-upload-preview join-upload-banner-preview">
                            {bannierePreviewUrl ? (
                              <img src={bannierePreviewUrl} alt="Apercu de la banniere marketplace" className="join-upload-preview-image" style={{ aspectRatio: BANNER_ASPECT_RATIO, objectFit: 'cover' }} />
                            ) : (
                              <CheckCircle className="join-upload-success-icon" />
                            )}
                          </div>
                        ...
                        <>
                          ...
                          <p className="join-upload-hint">PNG, JPG, WEBP ou SVG (max. 5 Mo) · recommandé : {BANNER_RECOMMENDED_DIMENSIONS}</p>
                      </>
                    )}
                  </label>
