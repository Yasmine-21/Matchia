                ...
                >
                  ...
                  {form.banniereFile ? (
                    ...
                    <div className="w-full space-y-3">
                      ...
                      />
                      <div className="text-xs text-slate-500">Cliquez pour remplacer la bannière. Recommandé : {BANNER_RECOMMENDED_DIMENSIONS}</div>
                    </div>
                  ) : (
                    <>
                      <Upload className="h-8 w-8 text-slate-400" />
                      <div className="mt-2 text-sm font-semibold text-gray-900">Importer une bannière</div>
                      <div className="text-xs text-slate-500">Recommandé : {BANNER_RECOMMENDED_DIMENSIONS}</div>
