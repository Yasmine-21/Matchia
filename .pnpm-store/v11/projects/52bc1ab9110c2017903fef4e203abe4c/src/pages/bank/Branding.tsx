...
import { BANNER_ASPECT_RATIO, BANNER_BACKGROUND_STYLE, BANNER_RECOMMENDED_DIMENSIONS } from '../../config/banner';
          ...
          <Card>
            ...
            <CardContent className="branding-form-spacing">
              ...
              <div>
                ...
                <div className="branding-upload-area">
                  {bannerSrc ? (
                    <img src={bannerSrc} alt="Bannière de la marketplace" className="branding-upload-banner-preview" style={{ aspectRatio: BANNER_ASPECT_RATIO }} />
                  ) : (
                    <Upload className="branding-upload-icon" />
                  )}
                  <p className="branding-upload-title">Bannière personnalisée</p>
                  <p className="branding-upload-hint">Dimensions recommandées : {BANNER_RECOMMENDED_DIMENSIONS}</p>
            ...
            <CardContent>
              <div className="branding-preview-card" ref={previewRef}>
                <div
                  ...
                  style={bannerSrc
                    ? BANNER_BACKGROUND_STYLE(bannerSrc)
                    : {
