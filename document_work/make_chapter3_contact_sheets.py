...
pages_dir = Path(r"D:\PFE M2\Platforme SaaS\document_work\rendered_chapter3\pages_final")
output_dir = Path(r"D:\PFE M2\Platforme SaaS\document_work\rendered_chapter3\contact_sheets_final")
output_dir.mkdir(parents=True, exist_ok=True)

page_paths = sorted(pages_dir.glob("page-*.png"), key=lambda path: int(path.stem.split("-")[-1]))
cols, rows = 3, 3
thumb_w = 420
gap = 24
label_h = 28
