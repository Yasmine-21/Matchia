...
export function ClientProfilePage() {
  ...
  const photoSource = photoPreview || getBackendAssetUrl(profile.contactImageUrl);
...
export function FinancingApplicationPage() {
  ...
  const productImage = getBackendAssetUrl(context.productImageUrl);
...
function assetUrl(value: string) { return value.startsWith('http://') || value.startsWith('https://') ? value : `${getApiBaseUrl()}${value}`; }
